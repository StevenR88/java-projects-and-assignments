...
public class RPNCalculatorTest {
    ...
    /*
     * STUDENT SUBMITTED TESTS - OPTIONAL
     */
    @Test
    public void processFormulaRemainder() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
    ...
    @Test
    public void processFormulaUnholyMessNew4() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(10);
        final int expected = 35;
        String input = "99 88 77 66 55 + + + + 4 3 2 1 1 + + + + /";
        final int actual = calculator.processFormula(input);
        assertEquals(expected, actual);
    }
    /*
     * END STUDENT SUBMITTED TESTS - OPTIONAL
     */
